...
// import Members from "./components/pages/admin/Members";
// import MemberDetail from "./components/pages/admin/MemberDetail";
// import CallDetailsAdmin from "./components/pages/admin/CallDetails"; // Assuming you have a separate component for admin

// // Layout component to wrap all pages and manage Navbar/Sidebar visibility
// function Layout() {
//     const location = useLocation();
...
//     // Show sidebar only on user dashboard routes
...
//                 {showSidebar && <Sidebar />}
//                 {/* Main content area with padding for all pages */}
...
//                         {/* --- Not Found Route (Catches all other paths) --- */}
//                         <Route path="*" element={<NotFound />} />
//                     </Routes>
//                 </main>
//             </div>
//             {/* Footer will not be shown on admin routes */}
//             {/* {!isAdminRoute && <Footer />} */}
//             <Footer />
//         </div>
//     );
